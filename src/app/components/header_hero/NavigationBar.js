...
export default function NavigationBar() {
    ...
    return (
        ...
        >
            ...
            {/* Mobile Menu */}
            {isOpen && (
            <div ref={mobileMenuRef} className="md:hidden bg-blue-50 border-t border-blue-200">
        ...
        {showTopBtn && (
            ...
            className="fixed bottom-6 right-6 p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 z-[9999] group"
