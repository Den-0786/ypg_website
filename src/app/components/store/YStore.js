...
const storeItems = [
    {
        ...
        rating: 4.5,
        treasurer: { name: "Elder Kwame Boateng", phone: "+233201234567" }
    },
    {
        id: 2,
        name: "Branded Cap",
    ...
    },
    {
        ...
        price: "GHC 60",
        image: "/images.jpeg",
        description: "Warm fleece hoodie with youth group branding",
        rating: 4.7,
        treasurer: { name: "Elder Kwame Boateng", phone: "+233201234567" }
    },
    {
        ...
        price: "GHC 25",
        image: "/images (1).jpeg",
        description: "Durable Bible cover with zipper pocket",
        rating: 4.3,
        treasurer: { name: "Elder Kwame Boateng", phone: "+233201234567" }
    }
    ];
    ...
    return (
        <section id="ystore" className="py-16 bg-gradient-to-b from-white to-gray-50 px-4">
                ...
                >
                    ...
                    >
                        ...
                        <div className="p-5">
                             ...
                             <span className="text-blue-600 font-bold text-sm ml-2">{item.price}</span>
                         </div>
                        
                        <div className="mt-4 space-y-3">
                            <p className="text-xs text-gray-500 italic">
                            Contact treasurer: {item.treasurer.name}
                            </p>
                            
                            <div className="flex gap-2">
                            <a
                                href={`https://wa.me/${item.treasurer.phone.replace(/\D/g, '')}`}
                                target="_blank"
