    ...
    <section className="py-16 px-4 bg-green-50">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="text-sm font-medium">Submit Ad</span>
              </button>
            </div>
          </div>
        ...
        {filteredAdvertisements.length === 0 ? (
          ...
          <div
            className={`${filteredAdvertisements.length === 1 ? "flex justify-center items-start gap-4 sm:gap-8 px-2" : "flex justify-center items-start gap-4 sm:gap-8 overflow-x-auto pb-4"}`}
          >
            {filteredAdvertisements.map((ad, index) => {
              ...
              const cardKey = `card-${ad.id}-${index}`;
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 w-full max-w-64 flex-shrink-0 self-start"
                >
                  {/* Image Carousel */}
                  <div
