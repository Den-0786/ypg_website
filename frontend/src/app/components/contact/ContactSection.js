            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="flex gap-4">
                {socialMediaLinks.map((link) => {
                  // Platform-specific icon SVG paths
                  ...
                  const getHoverColor = (platform) => {
                    switch (platform) {
                      ...
                      default:
                        return 'hover:bg-gold-100 hover:text-gold-500';
                    }
                  };
                  ...
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`p-2 bg-blue-50 rounded-full text-gray-700 transition ${getHoverColor(link.platform_name)}`}
                    ...
                    >
                      {link.icon_file ? (
                        ...
                        <svg
                          ...
                          viewBox="0 0 24 24"
                        >
                          <path d={getIconPath(link.platform_name)} />
                        </svg>
                      )}
                    </a>
                  );
