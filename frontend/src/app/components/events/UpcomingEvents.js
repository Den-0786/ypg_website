          ...
          {events.map((event) => {
            ...
            return (
              <SwiperSlide key={event.id}>
                <motion.div
                  className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col border border-gray-100 max-w-sm mx-auto w-full"
