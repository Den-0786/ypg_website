      ...
      >
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-3xl font-bold text-navy-950 mb-6">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-3xl font-bold text-navy-950 mb-6">2. Use License</h2>
            ...
            <h2 className="text-3xl font-bold text-navy-950 mb-6">3. Disclaimer</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-3xl font-bold text-navy-950 mb-6">4. Limitations</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-3xl font-bold text-navy-950 mb-6">5. Accuracy of Materials</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-3xl font-bold text-navy-950 mb-6">6. Links</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-3xl font-bold text-navy-950 mb-6">7. Modifications</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-3xl font-bold text-navy-950 mb-6">8. Governing Law</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div className="mt-12 p-6 bg-blue-50 rounded-xl border border-blue-200">
              <h3 className="text-xl font-semibold text-navy-950 mb-3">Contact Information</h3>
