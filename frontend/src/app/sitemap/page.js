                  ...
                  >
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <h3 className="text-xl font-semibold text-navy-950 group-hover:text-gold-500 transition">
                          {page.title}
                        </h3>
                        <ExternalLink
                          size={16}
                          className="text-gray-400 group-hover:text-gold-500 transition"
                        />
                      </div>
              ...
              <div className="p-6 bg-blue-50 rounded-xl">
                ...
                <ul className="space-y-2">
                  <li>
                    <Link
                      href="/terms"
                      className="text-gold-500 hover:text-navy-950 transition"
                    >
                      Terms of Service
                    </Link>
                  </li>
