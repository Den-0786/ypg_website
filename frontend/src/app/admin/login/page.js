    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 bg-gray-800 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          <div className="mb-8">
            <div className="w-24 h-24 mx-auto bg-gradient-to-br from-gold-400 to-teal-400 rounded-2xl flex items-center justify-center shadow-2xl">
      ...
      <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center bg-white p-4 sm:p-8">
        <motion.div
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            ...
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold text-navy-950 mb-2">Admin Login</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gold-500 hover:bg-gold-600 text-white py-3.5 px-4 rounded-xl font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-lg shadow-blue-600/20 hover:shadow-blue-600/30"
              >
                {isLoading ? (
                  <>
